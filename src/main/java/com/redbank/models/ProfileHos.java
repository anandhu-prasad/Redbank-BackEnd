...
public class ProfileHos {
    ...
    @GenericGenerator(name = "hospitals_seq", strategy = "com.redbank.util.StringSequenceIdentifier", parameters = {
    ...
    @Pattern(regexp = "^\\d{10}||null$", message = "Invalid phone number.")
    ...
    public ProfileHos(String name, String email, String licenseNumber, String phone1, String phone2, String phone3, String phone4, String phone5, String address, String state, String district, String pincode, String password, Timestamp registrationDate) {
        this.name = name;
        this.email = email;
